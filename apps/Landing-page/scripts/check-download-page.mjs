...
assert(
  links.includes("const currentReleaseVersion = 'v1.12.5';"),
  'Release metadata should name the current v1.12.5 beta.',
);
assert(
...
assert(page.includes('GRIDGO-v1.12.5.apk'), 'Download page should offer the pinned v1.12.5 APK.');
