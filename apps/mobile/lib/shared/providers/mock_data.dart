...
class MockData {
  ...
  static final List<Order> orders = [
    ...
    Order(
      ...
      paymentStatus: PaymentStatus.paid,
      orderStatus: OrderStatus.approvedForMatching,
      deliveryOption: 'delivery',
    ...
    Order(
      ...
      paymentMethod: PaymentMethod.cod,
      paymentStatus: PaymentStatus.pending,
      orderStatus: OrderStatus.fileRejected,
      declineReason:
    ...
    Order(
      ...
      paymentMethod: PaymentMethod.gcash,
      paymentStatus: PaymentStatus.paid,
      orderStatus: OrderStatus.collectedByCustomer,
      deliveryOption: 'pickup',
  ...
  static final List<OrderStatusHistory> orderStatusHistory = [
    ...
    OrderStatusHistory(
      ...
      toStatus: OrderStatus.approvedForMatching,
    ...
    OrderStatusHistory(
      id: 'osh_002',
      orderId: 'ord_005',
      fromStatus: OrderStatus.approvedForMatching,
    ...
    OrderStatusHistory(
      ...
      toStatus: OrderStatus.supplierSelfQc,
      changedByUserId: 'usr_003',
      createdAt: _now.subtract(const Duration(days: 2)),
    ),
    OrderStatusHistory(
      id: 'osh_004',
      orderId: 'ord_005',
      fromStatus: OrderStatus.supplierSelfQc,
    ...
    OrderStatusHistory(
      ...
      toStatus: OrderStatus.outForDelivery,
      changedByUserId: 'usr_002',
    ...
    OrderStatusHistory(
      ...
      orderId: 'ord_008',
      fromStatus: OrderStatus.submitted,
      toStatus: OrderStatus.fileRejected,
      changedByUserId: 'usr_003',
