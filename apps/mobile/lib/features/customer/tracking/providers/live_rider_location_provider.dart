...
final liveRiderLocationProvider = StateProvider<LocationUpdate?>((ref) => null);

final liveLocationSocketHealthProvider = StateProvider<LocationSocketHealth>(
  (ref) => LocationSocketHealth.disconnected,
);
