...
class RiderActiveBanner extends StatelessWidget {
  const RiderActiveBanner({super.key, required this.view, required this.onTap});
  ...
  Widget build(BuildContext context) {
    ...
    return Semantics(
      button: true,
      label: 'Continue delivery. ${view.order.orderRef}. ${visual.label}.',
      onTap: onTap,
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: AppTypography.caption.copyWith(
                              color: colors.accentOnColor.withValues(
                                alpha: 0.8,
                              ),
                            ),
                          ),
